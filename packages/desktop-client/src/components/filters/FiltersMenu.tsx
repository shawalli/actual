...
import { nativeToShortcode } from '@actual-app/core/shared/emoji';
...
function ConfigureField<T extends RuleConditionEntity>({
  ...
  // For ops that only care whether the value is empt or not
  const isEmptyOp = (op: T['op']) => ['isSet', 'isNotSet'].includes(op);
